...
import com.example.cristianoyl.restaurant.fragments.card.CardFragment.OnCardFragmentInteractionListener;
 ...
 * specified {@link CardFragment.OnCardFragmentInteractionListener}.
...
public class MyCardRecyclerViewAdapter extends RecyclerView.Adapter<MyCardRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCardRecyclerViewAdapter(List<DummyItem> items, OnCardFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onCardSelected(holder.mItem);
                }
            }
        });
    }
